...
import { useCreateDiscountVoucher, useCreateInstructor } from "@/hooks/api/mutations/admin";
import { DEFAULT_PASSWORD } from "@/lib/config";
import { combineToISOString, defaultDate, formatCurrency } from "@/lib/helper";
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      const payload = {
        ...
        valid_from: combineToISOString(data?.valid_from, data?.valid_time_from),
        valid_until: combineToISOString(data?.valid_until, data?.valid_time_until),
