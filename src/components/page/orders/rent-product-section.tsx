...
export const RentProductSectionTabComponent = () => {
    ...
    <Card className="border-brand-100 w-full" >
      <CardHeader className="flex flex-row justify-between w-ful items-center">
        <div className="flex flex-col gap-1">
          <h3 className="text-2xl text-brand-999 font-medium">Products for Rent</h3>
          <p className="text-sm text-gray-500">Enter customer information to rent product(s)</p>
        </div>
